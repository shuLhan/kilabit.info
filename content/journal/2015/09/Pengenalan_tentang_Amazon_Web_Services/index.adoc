...
image::/assets/images/amazon-web-services.png[200,float="right",alt="Amazon Web Services"]
...
image::/assets/images/amazon_web_cloud.jpg[Amazon storage,200,float="right"]
