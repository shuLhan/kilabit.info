...
https://www.linuxfromscratch.org/blfs/view/stable/kde/kde.html[BLFS's guide^].
...
https://www.linuxfromscratch.org/blfs/view/svn/x/x.html[here^].

--

*  https://www.linuxfromscratch.org/blfs/view/svn/x/x.html
