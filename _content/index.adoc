...
+
https://sr.ht/~shulhan/awwan/[Source]
...
+
https://sr.ht/~shulhan/ciigo[Source]
...
This program exist long before before `godep` or Go module exist and stable.
+
https://github.com/shuLhan/beku[Source (frozen)]
...
Its written in C.
+
https://github.com/shuLhan/vos[Source (unmaintained)]
...
+
https://github.com/shuLhan/libvos[Source (unmaintained)]
