...
https://github.com/shuLhan/haminer[haminer^]::
...
https://github.com/shuLhan/vos[vos (unmaintained)^]::
...
https://github.com/shuLhan/libvos[libvos (unmaintained)^]::
...
Some other websites worth to read,
